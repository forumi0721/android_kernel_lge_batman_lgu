	...
	void *ndev)
{
	...
	struct wl_priv *wl = wlcfg_drv_priv;
    //LGE_CHANGE_S, [jaewoo.hwang@lge.com], 2012-05-18, <Broadcom Patch, Kernel Crash Issue, P2P Group Owner>
    int refcnt = 0;
    //LGE_CHANGE_E, [jaewoo.hwang@lge.com], 2012-05-18, <Broadcom Patch, Kernel Crash Issue, P2P Group Owner>
