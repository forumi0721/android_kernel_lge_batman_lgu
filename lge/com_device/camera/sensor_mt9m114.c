...
/*=============================================================
	Switching Log(jungki.kim@lge.com, 2012-04-10)
==============================================================*/
...
//LGE_BSP_CAMERA_S::jungki.kim@lge.com  2011-04-09  AEC/AWB Lock
static int prev_awb_mode;
static int prev_aec_mode;
//LGE_BSP_CAMERA_E::jungki.kim@lge.com  2011-04-09  AEC/AWB Lock
...
// LGE_BSP_CAMERA_S :: jungki.kim@lge.com  2012-04-27  Support Below Rev.E for DCM
...
#endif
// LGE_BSP_CAMERA_E :: jungki.kim@lge.com  2012-04-27  Support Below Rev.E for DCM
/*=============================================================*/
...
// LGE_BSP_CAMERA_S:: jungki.kim@lge.com  2012-04-09  Add AWB, AEC Lock Function
/*===========================================================================
 * FUNCTION    - mt9m114_set_awb_lock -
 *
 * DESCRIPTION: AWB Lock Function for Front Camera by jungki.kim@lge.com in LGE_BSP_CAMERA Team
 *==========================================================================*/
...
/*===========================================================================
 * FUNCTION    - mt9m114_set_aec_lock -
 *
 * DESCRIPTION: AEC Lock Function for Front Camera by jungki.kim@lge.com in LGE_BSP_CAMERA Team
 *==========================================================================*/
...
// LGE_BSP_CAMERA_E:: jungki.kim@lge.com  2012-04-09  Add AWB, AEC Lock Function
...
int mt9m114_sensor_config(void __user *argp)
{
	...
	CDBG("mt9m114_ioctl, cfgtype = %d, mode = %d\n",
		...
		case SENSOR_AE_METERING:	//LGE_CAMERA: AE_metering - jonghwan.ko@lge.com
			rc = mt9m114_set_AE_metering(cfg_data.mode);
			break;
		
		case CFG_FIXED_FPS:			// LGE_CAMERA : Adjust VT Cam frame rate - jonghwan.ko@lge.com
			rc = mt9m114_set_Fps(cfg_data.mode);
			break;
		
		case CFG_VT_AWB_LOCK:		// LGE_BSP_CAMERA::jungki.kim@lge.com  2012-04-09  AWB/AEC Lock for Front Camera
			rc = mt9m114_set_awb_lock(cfg_data.mode);
			break;

		case CFG_VT_AEC_LOCK:		// LGE_BSP_CAMERA::jungki.kim@lge.com  2012-04-09  AWB/AEC Lock for Front Camera
...
//LGE_CAMERA_S : FPS - jonghwan.ko@lge.com
	prev_fps_mode = -1;
//LGE_CAMERA_E : FPS - jonghwan.ko@lge.com	
	prev_awb_mode = -1;	// LGE_BSP_CAMERA::jungki.kim@lge.com  2012-04-09  AWB/AEC Lock for Front Camera
	prev_aec_mode = -1;	// LGE_BSP_CAMERA::jungki.kim@lge.com  2012-04-09  AWB/AEC Lock for Front Camera
