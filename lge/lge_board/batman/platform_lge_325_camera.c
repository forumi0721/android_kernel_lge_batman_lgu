...
static uint32_t camera_off_gpio_table[] = {
	...
	GPIO_CFG(GPIO_LED_FLASH_EN, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)	// jungki.kim@lge.com  2012-03-02  add flsh gpio
};
static uint32_t camera_on_gpio_table[] = {
	...
	GPIO_CFG(GPIO_LED_FLASH_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)	// jungki.kim@lge.com  2012-03-02  add flash gpio
};
...
void  main_camera_power_on (void)
{
	...
	// jungki.kim@lge.com  2011-09-29  Reset Pin has to be High when Camera start.
	gpio_set_value(GPIO_8M_CAM_RESET_N, 1);
	mdelay(10);
	printk(KERN_EMERG "[CAMERA] GPIO_8M_CAM_RESET_N : HIGH\n");
	// jungki.kim@lge.com  2011-09-29  END
...
void  vt_camera_power_on (void)
{
	...
	/*
	2011-12-09 jungki.kim@lge.com
	LG IT recommaned VT Camera Power on Sequence as following.
	DVDD -> IOVDD -> AVDD
	*/
	/* +1V8_VTCAM_DVDD*/ // First
...
// jungki.kim@lge.com  2011-09-01  I2C was already enabled.
#if 0
	/* +1V8_8MCAM_VIO*/
	lvs0_1p8 = regulator_get(NULL, "8058_lvs0");
	if (IS_ERR(lvs0_1p8)) {
...
/*========================================================================
	  LGE Camera Sensor  (Main Camera : MT9E013 , VT Camera : MT9M114)
  ======================================================================*/
